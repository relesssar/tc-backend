/*
Скрипт для запуска по крону, проверка на "Контроль временного отключения",
подробнее https://tc.jusanmobile.kz:9000/swagger/index.html#/Problem_Router_Onyma/check_time_pause
*/
...
func main() {
	...
	fmt.Println("Запускаю проверку на наличие проблемных строк")
	url = "https://tc.jusanmobile.kz:9000/api/router_onyma/problem/check_control_time_pause"
